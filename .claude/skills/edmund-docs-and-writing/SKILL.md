...
4. **Common PR-template structure.** Both PR bodies and review comments
   open with the attribution line from `edmund-pr-review` §5
   (`> 🤖 Generated by Claude Code. Revised with human feedback. Reviewed by
   the dev 💁‍♀️`). PR body: `Summary` (what and why, 1–3
